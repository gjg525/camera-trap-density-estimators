...
Estimating proportional staying time can be done with camera trap stay time data or telemetry data. We model the TDST with both methods separately, and estimate stay time proportions for the habitat PR model with tele prior information.

...
# 
# D_all <- tibble::tibble()
# for (ii in 3:length(file_names)) {
#   print(ii)
#   all_results <- loadRData(paste0("Sim_results/results_", file_names[ii], "_cam.RData"))
#   
...
# }
# 
# save(D_all, file = "Sim_results/D_all.RData")

load("Sim_results/D_all.RData")
...
D_all %>% 
  ...
  ggplot2::geom_hline(yintercept=nind, linetype="dashed", size = 0.7) +

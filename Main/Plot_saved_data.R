...
plot(seq(0.9,4.9,by=1), 
     ...
     xlim=c(0.5,5.5),xlab="Method", 
     ylab=paste(cam.props.label,"\n Mean Estimates"), 
     pch=16, col="blue", cex=1.8, xaxt = "n", cex.lab = 1.5, cex.axis = 1.3)
# points(seq(1.1,5.1,by=1),SD.all.MCMC.Means, col="blue", pch=16,cex=1.8)
points(seq(1.1,5.1,by=1),SD.all.MCMC.cov.Means, col="blue", pch=1,cex=1.8)
